...
import mapBackground from '../img/map-background.png'; // Use a imagem de mapa que você tem
import HelpCard from './HelpCard'; // Importe o componente que já criamos
        ...
        {cities.map((city, index) => (
          ...
          >
            <div className="flex items-center justify-center h-24 bg-gray-200 rounded-lg mb-4">
              ...
              <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-gray-400">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l1.5 1.5 2.25-2.25m3.75-8.25L12 9l6-3m3 2.25l-2.25 2.25m0 0l-3.6-3.6m3.6 3.6l-1.5 1.5-3.75-3.75M18 19.5l-2.25-2.25m0 0L12 21.75l-6-3m6-2.25l-2.25 2.25M10.5 6h.008v.008h-.008V6zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
              </svg>
            </div>
